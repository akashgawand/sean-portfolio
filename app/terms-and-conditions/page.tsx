  ...
  return (
    <main className="min-h-screen bg-[#000000] text-white font-sans selection:bg-[#00c3ff] selection:text-white px-4 sm:px-6 py-8 sm:py-12 md:px-12 lg:px-24 md:py-20 lg:py-28">
      <div className=" max-w-[75rem] mx-auto w-full">
        ...
        <section className="mt-12 sm:mt-16 md:mt-22 mb-10 sm:mb-16">
          ...
          <div className="text-[13px] md:text-[15px] text-[#b0b0b0] leading-relaxed font-medium space-y-8 max-w-[65rem]">
            ...
            <div>
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#e0e0e0] mb-3 sm:mb-4 wrap-break-word">1. Agreement to Terms</h2>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#e0e0e0] mb-3 sm:mb-4 wrap-break-word">2. Modifications to Terms</h2>
              <p>
            ...
            {/* 3. Use of the Site */}
            <div>
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#e0e0e0] mb-3 sm:mb-4 wrap-break-word">3. Use of the Site</h2>
              <p className="mb-4">
            ...
            <div>
              <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#e0e0e0] mb-3 sm:mb-4 wrap-break-word">4. Products, Services, and Events</h2>
              <p className="mb-4">
            ...
            <div>
               <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#e0e0e0] mb-3 sm:mb-4 wrap-break-word">5. Purchases and Payment</h2>
               <p className="mb-4">
            ...
            <div>
               <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#e0e0e0] mb-3 sm:mb-4 wrap-break-word">6. Intellectual Property Rights</h2>
               <p>
            ...
            <div>
               <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#e0e0e0] mb-3 sm:mb-4 wrap-break-word">7. Digital Millennium Copyright Act (DMCA)</h2>
               <p className="mb-4">
            ...
            <div>
               <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#e0e0e0] mb-3 sm:mb-4 wrap-break-word">8. SMS Communications Program</h2>
               
               <h3 className="text-base sm:text-lg font-bold text-white mb-2 mt-5 sm:mt-6 wrap-break-word">8.1 Program Description</h3>
               <p className="mb-4">
               ...
               <h3 className="text-base sm:text-lg font-bold text-white mb-2 mt-5 sm:mt-6 wrap-break-word">8.2 Consent and Opt-In</h3>
               <p className="mb-4">
               ...
               <h3 className="text-base sm:text-lg font-bold text-white mb-2 mt-5 sm:mt-6 wrap-break-word">8.3 Message Frequency and Timing</h3>
               <p className="mb-4">
               ...
               <h3 className="text-base sm:text-lg font-bold text-white mb-2 mt-5 sm:mt-6 wrap-break-word">8.4 Message and Data Rates</h3>
               <p>
               ...
               <h3 className="text-base sm:text-lg font-bold text-white mb-2 mt-5 sm:mt-6 wrap-break-word">8.5 Opt-Out / Stop</h3>
               <p className="mb-4">
               ...
               <h3 className="text-base sm:text-lg font-bold text-white mb-2 mt-5 sm:mt-6 wrap-break-word">8.6 Opt Back In</h3>
               <p>
               ...
               <h3 className="text-base sm:text-lg font-bold text-white mb-2 mt-5 sm:mt-6 wrap-break-word">8.7 Help</h3>
               <p>
               ...
               <h3 className="text-base sm:text-lg font-bold text-white mb-2 mt-5 sm:mt-6 wrap-break-word">8.8 Supported Carriers</h3>
               <p>
               ...
               <h3 className="text-base sm:text-lg font-bold text-white mb-2 mt-5 sm:mt-6 wrap-break-word">8.9 SMS Privacy</h3>
               <p className="mb-4">
            ...
            <div>
               <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#e0e0e0] mb-3 sm:mb-4 wrap-break-word">9. Regulatory Compliance</h2>
               
               <h3 className="text-base sm:text-lg font-bold text-white mb-2 mt-5 sm:mt-6 wrap-break-word">9.1 Telephone Consumer Protection Act (TCPA)</h3>
               <p>
               ...
               <h3 className="text-base sm:text-lg font-bold text-white mb-2 mt-5 sm:mt-6 wrap-break-word">9.2 CTIA Messaging Principles and Best Practices</h3>
               <p>
               ...
               <h3 className="text-base sm:text-lg font-bold text-white mb-2 mt-5 sm:mt-6 wrap-break-word">9.3 A2P 10DLC Compliance</h3>
               <p>
               ...
               <h3 className="text-base sm:text-lg font-bold text-white mb-2 mt-5 sm:mt-6 wrap-break-word">9.4 Canada&apos;s Anti-Spam Legislation (CASL)</h3>
               <p>
               ...
               <h3 className="text-base sm:text-lg font-bold text-white mb-2 mt-5 sm:mt-6 wrap-break-word">9.5 State-Specific SMS Compliance</h3>
               <p>
               ...
               <h3 className="text-base sm:text-lg font-bold text-white mb-2 mt-5 sm:mt-6 wrap-break-word">9.6 FCC Revoke-All Rule</h3>
               <p>
            ...
            <div>
               <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#e0e0e0] mb-3 sm:mb-4 wrap-break-word">10. Disclaimer of Warranties</h2>
            ...
            <div>
               <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#e0e0e0] mb-3 sm:mb-4 wrap-break-word">11. Limitation of Liability</h2>
               <p className="mb-4 uppercase">
            ...
            {/* 12. Indemnification */}
            <div>
               <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#e0e0e0] mb-3 sm:mb-4 wrap-break-word">12. Indemnification</h2>
               <p>
            ...
            <div>
               <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#e0e0e0] mb-3 sm:mb-4 wrap-break-word">13. Governing Law and Dispute Resolution</h2>
               <p className="mb-4">
            ...
            {/* 14. Severability */}
             <div>
               <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#e0e0e0] mb-3 sm:mb-4 wrap-break-word">14. Severability</h2>
               <p>
             ...
             {/* 15. Entire Agreement */}
             <div>
               <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#e0e0e0] mb-3 sm:mb-4 wrap-break-word">15. Entire Agreement</h2>
               <p>
             ...
             {/* 16. No Waiver */}
             <div>
               <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#e0e0e0] mb-3 sm:mb-4 wrap-break-word">16. No Waiver</h2>
               <p>
